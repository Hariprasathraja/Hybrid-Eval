def generate_insights(evaluation_results):
    ...
    prod_logic = {"completeness": [], "relevance": [], "factuality": []}  # Added factuality
    shad_logic = {"completeness": [], "relevance": [], "factuality": []}  # Added factuality
    ...
    temporal_insights = analyze_temporal_trends(time_ordered_results)
    session_insights = analyze_session_performance(session_data)
...
def analyze_temporal_trends(time_ordered_results):
    """
